...
### 1. Выход результатов за рамки допустимого диапазона
...
### 2. Логическое противоречие классификации
...
### 3. Логические пропуски в метриках посещаемости
...
### 4. Невалидные идентификаторы граждан (ИИН)
...
### 5. Гендерно-грамматические ошибки в фамилиях
